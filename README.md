...
- Nội dung chi tiết được render sẵn trong HTML nên không bị trắng khi JavaScript tải chậm hoặc lỗi.
- Ảnh minh chứng đặt ngay cạnh bước/prompt/công cụ tương ứng; các bảng được dựng thành bảng HTML có đường kẻ và cuộn ngang trên mobile.
- Header tablet/mobile dùng menu gọn một hàng, không đè hoặc làm trôi các nút trong phần hero.
